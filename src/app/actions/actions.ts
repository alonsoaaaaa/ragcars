...
export async function createChatAnswer(
  ...
  if (questionOrImg.search("data:image") !== -1) {
    userInput = { inlineData: { data: questionOrImg, mimeType: "jpg" } };
  } else {
    userInput = {
      text: questionOrImg,
    };
